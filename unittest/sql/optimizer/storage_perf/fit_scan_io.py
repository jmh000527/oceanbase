...
scan_io_model.set_param_hint("Tper_row_io_wait", min=0.0)
scan_io_model.set_param_hint("Tper_row_pipline_factor", min=0.0, max=0.1)
...
if __name__ == '__main__':
    ...
    Tper_row_io_wait = result.best_values["Tper_row_io_wait"]
