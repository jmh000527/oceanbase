...
/*
TEST_F(ObExprNotEqualTest, basic_test)
{
  ObExprNotEqual ne;
  ObMalloc buf;
  ASSERT_EQ(2, ne.get_param_num());
  // special vs special
  T(null, , null, , MY_NULL);
  T(null, , min, , MY_NULL);
  T(min, , null, , MY_NULL);
...
TEST_F(ObExprNotEqualTest, promotion_test)
{
  // int vs float
  ObMalloc buf;
  ...
  //T(int, 1, varchar, "ab", MY_TRUE); // 1 < 0 == false
  ...
  //T(float, 1.0, varchar, "ab", MY_TRUE); // 1 < 0 == false
  ...
  //T(double, 1.0, varchar, "ab", MY_TRUE); // 1 < 0 == false
...
#define R(t1, v1, t2, v2, res) ROW1_COMPARE_EXPECT(ObExprNotEqual, &buf, calc, t1, v1, t2, v2, res)
TEST_F(ObExprNotEqualTest, row1_basic_test)
{
  ObMalloc buf;
  // special vs special
...
#define W(t11, v11, t12, v12, t21, v21, t22, v22, res) \
  ROW2_COMPARE_EXPECT(ObExprNotEqual, &buf, calc, t11, v11, t12, v12, t21, v21, t22, v22, res)

TEST_F(ObExprNotEqualTest, row2_basic_test)
{
  ObMalloc buf;
  // (int, int) vs (int int)
