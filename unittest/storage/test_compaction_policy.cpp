...
TEST_F(TestCompactionPolicy, destroy_parallel_merge_info)
{
  ...
  medium_info_.parallel_merge_info_.list_size_ = 1;
  ASSERT_EQ(OB_SUCCESS, medium_info_.parallel_merge_info_.generate_datum_rowkey_list(*medium_info_.allocator_, multi_range_split_array));
