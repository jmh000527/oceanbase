...
extern "C" {
#endif
#define OB_OLD_ZSTD_LIB_VERSION 1
/* ======   Dependency   ======*/
...
ZSTDLIB_API size_t ZSTD_compressCCtx(ZSTD_CCtx* ctx, void* dst, size_t dstCapacity, const void* src, size_t srcSize, int compressionLevel, int *zstd_version);
...
ZSTDLIB_API size_t ZSTD_decompressDCtx(ZSTD_DCtx* ctx, void* dst, size_t dstCapacity, const void* src, size_t srcSize, int *zstd_version);
