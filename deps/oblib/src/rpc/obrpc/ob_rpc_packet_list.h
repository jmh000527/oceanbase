...
PCODE_DEF(OB_HA_GET_TRANSFER_DEST_PREPARE_SCN, 0x4BD)
PCODE_DEF(OB_TABLET_LOCATION_BROADCAST, 0x4BE)
PCODE_DEF(OB_HA_CHECK_TRANSFER_IN_TABLET_ABORTED, 0x4BF)
PCODE_DEF(OB_HA_UPDATE_TRANSFER_META_INFO, 0x4C0)
...
//rebuild tablet
PCODE_DEF(OB_ROOT_REBUILD_TABLET, 0x4C5)
...
PCODE_DEF(OB_DETECT_CLIENT_SESSION_ALIVE, 0x564)
...
PCODE_DEF(OB_RELOAD_MASTER_KEY, 0x864)
...
PCODE_DEF(OB_CREATE_HIDDEN_TABLE_V2, 0x1665)

PCODE_DEF(OB_CHECK_NESTED_MVIEW_MDS, 0x1666)
// for sensitive rule
PCODE_DEF(OB_HANDLE_SENSITIVE_RULE_DDL, 0x1669)
PCODE_DEF(OB_REVOKE_SENSITIVE_RULE, 0x1670)
PCODE_DEF(OB_CHECK_SYS_TABLE_SCHEMA, 0x1679)
