...
#undef DEFINE_DEBUG_INTERFACE
  ...
  INTERFACE_DEF(INTERFACE_UTL_RAW_TRANSLATE, "UTL_RAW_TRANSLATE", (ObUtlRaw::translate))
  // end of utl_raw
...
#define DEFINE_DBMS_SCHEDULER_INTERFACE(symbol, func) \
  ...
  DEFINE_DBMS_SCHEDULER_INTERFACE(DBMS_SCHEDULER_EVALUATE_CALENDAR_STRING, ObDBMSScheduler::evaluate_calendar_string)
  //compatibility with old version syspackage
  DEFINE_DBMS_SCHEDULER_INTERFACE(DBMS_SCHEDULER_MYSQL_DISABLE, ObDBMSScheduler::disable)
  DEFINE_DBMS_SCHEDULER_INTERFACE(DBMS_SCHEDULER_MYSQL_ENABLE, ObDBMSScheduler::enable)
  DEFINE_DBMS_SCHEDULER_INTERFACE(DBMS_SCHEDULER_MYSQL_SET_ATTRIBUTE, ObDBMSScheduler::set_job_attribute)
