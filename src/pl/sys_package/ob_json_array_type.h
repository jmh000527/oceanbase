...
public:
  ...
  static int append_Null(ObPLExecCtx &plctx, ParamStore &params, ObObj &result);
  static int append(ObPLExecCtx &plctx, ParamStore &params, ObObj &result);
  static int append_boolean(ObPLExecCtx &plctx, ParamStore &params, ObObj &result);
  static int append_clob(ObPLExecCtx &plctx, ParamStore &params, ObObj &result);
  static int append_blob(ObPLExecCtx &plctx, ParamStore &params, ObObj &result);
  static int append_json(ObPLExecCtx &plctx, ParamStore &params, ObObj &result);
  static int append_all(ObPLExecCtx &plctx, ParamStore &params, ObObj &result);
private:
  ...
  static int append_inner(sql::ObExecContext &ctx,
                          sql::ParamStore &params,
                          common::ObObj &result,
