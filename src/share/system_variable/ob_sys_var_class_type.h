...
enum ObSysVarClassType
{
  ...
  SYS_VAR__CURRENT_DEFAULT_CATALOG = 10749,
  SYS_VAR_OB_ENABLE_PS_PARAMETER_ANONYMOUS_BLOCK = 10750,
  SYS_VAR_OB_HNSW_EXTRA_INFO_MAX_SIZE = 10751,
  SYS_VAR__PUSH_JOIN_PREDICATE = 10752,
  SYS_VAR_OB_SPARSE_DROP_RATIO_SEARCH = 10753,
  SYS_VAR_SQL_TRANSPILER = 10754,
};
