...
const char *ObRedisFmt::ERR_EXPIRE_TIME = "-ERR invalid expire time in 'expire' command\r\n";
const char *ObRedisFmt::SYNTAX_ERR = "-ERR syntax error\r\n";
const char *ObRedisFmt::FLOAT_ERR = "-ERR value is not a valid float\r\n";
const char *ObRedisFmt::INTEGER_ERR ="-ERR value is not an integer or out of range\r\n";
const char *ObRedisFmt::INTEGER_OUT_RANGE_ERR ="-ERR index out of range\r\n";
