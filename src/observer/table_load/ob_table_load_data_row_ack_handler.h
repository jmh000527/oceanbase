...
namespace observer
{
class ObTableLoadDataRowAckHandler : public storage::ObDirectLoadDMLRowHandler
{
public:
  ObTableLoadDataRowAckHandler() = default;
  virtual ~ObTableLoadDataRowAckHandler() = default;
