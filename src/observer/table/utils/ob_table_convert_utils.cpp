                                             ...
                                             ObObj &obj)
{
  ...
  if (GET_MIN_DATA_VERSION(MTL_ID(), data_version)) {
    ...
    LOG_WARN("not support json with data version less than 4_3_5_3", K(ret), K(data_version));
    LOG_USER_ERROR(OB_NOT_SUPPORTED, "json with data version less than 4_3_5_3");
