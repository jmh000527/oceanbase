...
namespace sql
{
class ObExprJsonArrayInsert : public ObFuncExprOperator
{
public:
  ...
  static int eval_json_array_insert(const ObExpr &expr, ObEvalCtx &ctx, ObDatum &res);
  
  virtual int cg_expr(ObExprCGCtx &expr_cg_ctx, const ObRawExpr &raw_expr, ObExpr &rt_expr) const override;

  virtual bool need_rt_ctx() const override { return true; }
private:
    DISALLOW_COPY_AND_ASSIGN(ObExprJsonArrayInsert);
private:
...
#endif // OCEANBASE_SQL_OB_EXPR_JSON_ARRAY_INSERT_H_