...
ObExprSTUnion::ObExprSTUnion(ObIAllocator &alloc)
    : ObFuncExprOperator(alloc, T_FUN_SYS_ST_UNION, N_ST_UNION, 2,
          VALID_FOR_GENERATED_COL, NOT_ROW_DIMENSION)
{}

ObExprSTUnion::~ObExprSTUnion()
{}

int ObExprSTUnion::calc_result_type2(ObExprResType &type, ObExprResType &type1,
...
int ObExprSTUnion::eval_st_union(const ObExpr &expr, ObEvalCtx &ctx, ObDatum &res)
{
  int ret = OB_SUCCESS;
