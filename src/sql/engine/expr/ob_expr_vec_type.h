...
namespace sql
{
class ObExprVecType : public ObFuncExprOperator
{
public:
  explicit ObExprVecType(common::ObIAllocator &alloc);
  virtual ~ObExprVecType() {}
  ...
  static int generate_vec_type(
          const ObExpr &raw_ctx,
          ObEvalCtx &eval_ctx,
          ObDatum &expr_datum);
private :
  //disallow copy
  DISALLOW_COPY_AND_ASSIGN(ObExprVecType);
};
}
}
#endif /* OCEANBASE_SRC_SQL_ENGINE_EXPR_OB_EXPR_VEC_TYPE_H_ */ 
