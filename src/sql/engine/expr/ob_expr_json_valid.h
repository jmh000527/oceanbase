...
#ifndef OCEANBASE_SQL_OB_EXPR_JSON_VALID_H_
...
namespace sql
{
class ObExprJsonValid : public ObFuncExprOperator
{
public:
  explicit ObExprJsonValid(common::ObIAllocator &alloc);
  virtual ~ObExprJsonValid();
...
private:
  DISALLOW_COPY_AND_ASSIGN(ObExprJsonValid);
};

} // sql
} // oceanbase
#endif // OCEANBASE_SQL_OB_EXPR_JSON_VALID_H_