...
namespace sql
{
ObExprVecType::ObExprVecType(ObIAllocator &allocator)
  : ObFuncExprOperator(allocator, T_FUN_SYS_VEC_TYPE, N_VEC_TYPE, MORE_THAN_ZERO, VALID_FOR_GENERATED_COL, NOT_ROW_DIMENSION)
{
  need_charset_convert_ = false;
}

int ObExprVecType::calc_result_typeN(ObExprResType &type,
                                       ObExprResType *types,
                                       int64_t param_num,
...
int ObExprVecType::calc_resultN(ObObj &result,
...
/*static*/ int ObExprVecType::generate_vec_type(
