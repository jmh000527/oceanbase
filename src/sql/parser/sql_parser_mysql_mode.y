...
//-----------------------------non_reserved keyword begin-------------------------------------------
        ...
        INCREMENT IS_TENANT_SYS_POOL INVISIBLE MERGE ISNULL INTERSECT INCREMENTAL INNER_PARSE ILOGCACHE INPUT INDEXED INCONSISTENT INDIVIDUAL INPLACE INSTANT
        ...
        MAX_UPDATES_PER_HOUR MAX_USER_CONNECTIONS MAXVALUE MEDIUM MEMORY MEMTABLE MESSAGE_TEXT META MICROSECOND
        ...
        OBSOLETE OBJECT OBJECT_NAME_DISPLAY OCCUR OF OFF OFFSET OLD OLD_PASSWORD ONE ONE_SHOT ONLY OPEN OPTIONS ORDINALITY ORIG_DEFAULT OWNER OLD_KEY OVER
        OBCONFIG_URL OJ
        OBJECT_ID
        ...
        PERCENT_RANK PERCENTILE_CONT PHASE PLAN PHYSICAL PLAINACCESS PLANREGRESS PLUGIN PLUGIN_DIR PLUGINS POINT POLYGON PERFORMANCE
        ...
        RANK READ_ONLY RECOVERY REJECT ROLE RULE RULES
...
| OBJECT_NAME_DISPLAY
{ malloc_terminal_node($$, result->malloc_pool_, T_FORMAT_OBJECT_NAME_DISPLAY); }
;
