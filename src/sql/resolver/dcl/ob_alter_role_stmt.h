...
#ifndef OCEANBASE_SQL_RESOLVER_DCL_OB_ALTER_ROLE_STMT_
#define OCEANBASE_SQL_RESOLVER_DCL_OB_ALTER_ROLE_STMT_
...
namespace sql
{
class ObAlterRoleStmt: public ObDDLStmt
{
public:
  explicit ObAlterRoleStmt(common::ObIAllocator *name_pool);
  ObAlterRoleStmt();
...
#endif //OCEANBASE_SQL_RESOLVER_DCL_OB_ALTER_ROLE_STMT_
